...
image::ocs/OCS-Pods-Diagram.png[Showing OCS4 pods]
...
image::ocs/OCP4-installed-operators.png[Openshift showing the installed operators in namespace openshift-storage]

Click on `Openshift Container Storage Operator` to get to the OCS
configuration screen.

.OCS configuration screen
image::ocs/OCS4-OCP43-config-screen-all.png[OCS configuration screen]
...
image::ocs/OCS4-OCP43-config-screen-storage-cluster.png[OCS Create Storage Cluster]

A dialog box will come up next.

.OCS create a new storage cluster
image::ocs/OCS4-config-screen-partial.png[OCS create a new storage cluster]
...
image::ocs/OCS4-config-screen-osd-size.png[OCS select storage size]
...
see all instances shown below as `Ready` Status in the Web Console matches the following diagram (some Status may be unknown):

.OCS instance overview after cluster install is finished
image::ocs/OCS4-OCP43-finished-cluster-install.png[OCS instance overview after cluster install is finished]
...
image::ocs/OCS-dashboard-healthy.png[OCS Dashboard after successful backing storage installation]
...
image::ocs/OCS-noobaa-dashboard-healthy.png[OCS Multi-Cloud-Gateway Dashboard after successful installation]
...
image::ocs/OCS4-OCP43-Storage-Cluster-overview-reachit.png[]
...
.OCP Monitoring Menu
image::ocs/metrics-alertingleftpanemenu.png[OCP Monitoring Menu]
...
image::ocs/metrics-alertingnamefilter.png[OCP Alert Name Filtering]
...
.OCP Metrics Menu
image::ocs/metrics-metricsleftpanemenu.png[OCP Metrics Menu]
