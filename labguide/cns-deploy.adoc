...
### Preparation for CNS
All of the following tasks are carried out as the `cloud-user` user on the master node _{{ MASTER_EXTERNAL_FQDN }}_. Before the deployment a couple of simple prerequisites need to be fulfilled.
