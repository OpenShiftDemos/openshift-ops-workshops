...
`/opt/lab/support/cns-secret.yaml`. It contains a base64-encoded version of
...
`/opt/lab/support/cns-storageclass.yaml` that describes the *StorageClass*
...
[source]
----
oc create -f /opt/lab/support/cns-storageclass.yml
----
