...
[source,bash,role="copypaste"]
----
grep '#cnsinfra_' /etc/ansible/hosts
----
...
[source,bash,role="copypaste"]
----
sed -i 's/#cnsinfra_//g' /etc/ansible/hosts
----
...
This playbook takes about 1-2 minutes to execute and will install an
entirely independent OCS cluster, including a separate `heketi` management
stack. Additional `StorageClasses` will be set up to make this storage
usable.
...
hawkular-cassandra-1-6gv0d   1/1       Running   0          3m        10.129.0.7   {{ INFRA_INTERNAL_FQDN }}
hawkular-metrics-zkp0h       1/1       Running   0          3m        10.130.0.8  {{ INFRA_INTERNAL_FQDN }}
hawkular-metrics-schema-fbxqs   0/1       Completed   0          4h        10.129.2.4   {{ INFRA_INTERNAL_FQDN }}
heapster-r2l2v               1/1       Running   0          3m        10.131.2.2   {{ INFRA_INTERNAL_FQDN }}
----
...
----
NAME                          READY     STATUS    RESTARTS   AGE       IP            NODE
logging-curator-1-cnpt8       1/1       Running   0          5m        10.131.2.8    {{ INFRA_INTERNAL_FQDN }}
logging-es-yeqpfrm5-1-l9k0t   1/1       Running   0          5m        10.129.0.16   {{ INFRA_INTERNAL_FQDN }}
...
logging-kibana-1-dfl8p        2/2       Running   0          5m        10.129.0.17   {{ INFRA_INTERNAL_FQDN }}
----
...
PersistentVolumeClaim objects in this project using `oc get pvc`:
