...
This playbooks takes about 4 minutes to execute and will install an entirely independent OCS cluster, including a separate `heketi` management stack. Additional `StorageClasses` will be set up to make this storage usable.
...
<8> The URL under which the Logging frontend UI (Kibana) will be available
