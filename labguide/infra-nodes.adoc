...
----
cat /opt/app-root/src/content/support/infra-nodes.sh
----
...
[source,bash,role="execute"]
----
bash /opt/app-root/src/content/support/infra-nodes.sh
----
...
[source,bash,role="execute"]
----
oc create -f /opt/app-root/src/content/support/cluster-monitoring-configmap.yaml
----
