...
NOTE: Record the password as it will be used in future steps.
...
To login define the username as `kubeadmin` and the password you recorded earlier.

{{ MASTER_URL }}

If you do not have the password readily avilable the command to acquire it is:
