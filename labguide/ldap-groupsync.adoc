...
wget http://idm.openshiftworkshop.com/pub/ca.crt -O /home/lab-user/content/support/ca.crt
oc create configmap ca-config-map --from-file=/home/lab-user/content/support/ca.crt -n openshift-config
oc apply -f /home/lab-user/content/support/oauth-cluster.yaml
----
...
ca: /home/lab-user/content/support/ca.crt
...
[source,bash,role="copypaste"]
----
oc adm groups sync --sync-config=/home/lab-user/content/support/groupsync.yaml --confirm
----
