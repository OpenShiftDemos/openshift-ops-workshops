...
link:https://docs.openshift.com/container-platform/3.11/install_config/configuring_authentication.html[authentication
...
oauthConfig:
  ...
  - challenge: true
    ...
    provider:
      ...
      ca: /etc/origin/master/idm_ldap_ca.crt <6>
      insecure: false
...
the
link:https://docs.openshift.com/container-platform/3.11/install_config/configuring_authentication.html#identity-providers_parameters[Identity provider Parameters] section for more information.
...
link:https://docs.openshift.com/container-platform/3.11/install_config/configuring_authentication.html#LDAPPasswordIdentityProvider[LDAP
...
many administrative aspects of the cluster), we can take a look at Prometheus and
...
prometheus-k8s   prometheus-k8s-openshift-monitoring.{{OCP_ROUTING_SUFFIX}}             prometheus-k8s   web       reencrypt     None
----
...
At this point you are viewing Prometheus. If
