...
metadata:
  ...
  creationTimestamp: "2019-04-29T17:30:15Z"
  generation: 1
  name: cluster
  resourceVersion: "1436"
  selfLink: /apis/config.openshift.io/v1/oauths/cluster
  uid: 7325df68-6aa4-11e9-9959-02774c6d6b2e
spec: {}
```
...
wget http://idm.openshiftworkshop.com/pub/ca.crt -O /tmp/ca.crt
oc create configmap ca-config-map --from-file=/tmp/ca.crt -n openshift-config
oc apply -f https://raw.githubusercontent.com/openshift/openshift-cns-testdrive/ocp4-prod/support/oauth-cluster.yaml
----
...
[source,bash,role="copypaste"]
----
wget https://raw.githubusercontent.com/openshift/openshift-cns-testdrive/ocp4-prod/support/groupsync.yaml -O /tmp/groupsync.yaml
