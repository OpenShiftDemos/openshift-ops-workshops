...
----
oc create -f https://raw.githubusercontent.com/openshift/openshift-cns-testdrive/ocp4-prod/support/openshift_logging_namespace.yaml
----
...
structures of data. The operator understand how to apply the data that is
