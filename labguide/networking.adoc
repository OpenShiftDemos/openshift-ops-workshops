...
[source,bash,role="copypaste"]
----
bash /home/ec2-user/content/support/create-net-projects.sh
----
...
[source,bash,role="copypaste"]
----
bash /home/ec2-user/content/support/test-connectivity.sh
----
...
[source,bash,role="copypaste"]
----
oc create -n netproj-b -f /home/ec2-user/content/support/network-policy-block-all.yaml
----
...
[source,bash,role="copypaste"]
----
oc create -n netproj-b -f /home/ec2-user/content/support/network-policy-allow-all-from-netproj-a.yaml
----
