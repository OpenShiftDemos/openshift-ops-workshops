...
[source,bash,role="execute"]
----
bash $HOME/content/support/create-net-projects.sh
----
...
[source,bash,role="execute"]
----
bash $HOME/content/support/test-connectivity.sh
----
...
[source,bash,role="execute"]
----
oc create -n netproj-b -f $HOME/content/support/network-policy-block-all.yaml
----
...
[source,bash,role="execute"]
----
oc create -n netproj-b -f $HOME/content/support/network-policy-allow-all-from-netproj-a.yaml
----
