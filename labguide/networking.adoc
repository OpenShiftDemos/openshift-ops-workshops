...
[source,bash,role="execute"]
----
bash /opt/app-root/src/content/support/create-net-projects.sh
----
...
[source,bash,role="execute"]
----
bash /opt/app-root/src/content/support/test-connectivity.sh
----
...
[source,bash,role="execute"]
----
oc create -n netproj-b -f /opt/app-root/src/content/support/network-policy-block-all.yaml
----
...
[source,bash,role="execute"]
----
oc create -n netproj-b -f /opt/app-root/src/content/support/network-policy-allow-all-from-netproj-a.yaml
----
