...
[source,bash,role="execute"]
----
mkdir /opt/app-root/src/content/support/backup/
cp /opt/app-root/src/content/support/cluster-workerocs-*.yaml --target-directory=/opt/app-root/src/content/support/backup/
