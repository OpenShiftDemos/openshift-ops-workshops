...
[source,bash,role="copypaste"]
----
cat /home/ec2-user/content/support/project_request_template.yaml
----
...
[source,bash,role="copypaste"]
----
oc create -f /home/ec2-user/content/support/project_request_template.yaml -n openshift-config
----
...
[source,bash,role="copypaste"]
----
oc apply -f /home/ec2-user/content/support/cr_project_request.yaml -n openshift-config
----
