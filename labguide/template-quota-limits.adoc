...
This handy command will replace the default configuration (a blank entry of
`''`) with the desired setting of `default/project-request`:
...
[TIP]
====
In OpenShift 3.11 there were some underlying changes to how the master
...
----
NAME                  CREATED AT
template-test-quota   2018-10-24T19:19:40Z
----
