...
link:https://docs.openshift.com/container-platform/3.10/dev_guide/templates.html[template
...
The
link:https://docs.openshift.com/container-platform/3.10/admin_guide/quota.html[quota
...
The
link:https://docs.openshift.com/container-platform/3.10/admin_guide/limits.html[limit
...
in the link:https://docs.openshift.com/container-platform/3.10/admin_guide/limits.html[limit
...
the
link:https://docs.openshift.com/container-platform/3.10/dev_guide/compute_resources.html[compute
...
link:https://docs.openshift.com/container-platform/3.10/admin_guide/multiproject_quota.html[multi-project
...
WARNING: If you are unfamiliar with the `vi` editor, you should probably use
the `nano` editor. In the `nano` editor, you can use `^O` (Control + O)
to save/write out the file after editing, and then `^X` to exit.
...
[TIP]
====
In OpenShift 3.10 there were some underlying changes to how the master
software is run. Part of this change included running the control plane
itself in containers. This involved a switch from a more traditional
`systemd`-type service to using a script to restart the various components.
====
