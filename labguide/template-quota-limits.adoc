...
[source,bash,role="execute"]
----
cat /home/lab-user/content/support/project_request_template.yaml
----
...
[source,bash,role="execute"]
----
oc create -f /home/lab-user/content/support/project_request_template.yaml -n openshift-config
----
...
[source,bash,role="execute"]
----
oc apply -f /home/lab-user/content/support/cr_project_request.yaml -n openshift-config
----
