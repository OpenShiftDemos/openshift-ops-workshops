...
[source,bash,role="execute"]
----
cat $HOME/content/support/project_request_template.yaml
----
...
[source,bash,role="execute"]
----
oc create -f $HOME/content/support/project_request_template.yaml -n openshift-config
----
...
[source,bash,role="execute"]
----
oc apply -f $HOME/content/support/cr_project_request.yaml -n openshift-config
----
