...
image::images/acmimages/RHACM_all_cluster.png[]
...
image::images/acmimages/credentials.png[]

image::images/acmimages/add_cred.png[]

=== You will need to provide connection details:

* Cloud Provider Credentials: Choose *Amazon Web Services* +

image::images/acmimages/aws_cred.png[]
...
image::images/acmimages/cred_basicinfo.png[]
...
image::images/acmimages/screen2.png[]
...
image::images/acmimages/pull_secret.png[]
...
image::images/acmimages/screen4.png[]
...
image::images/acmimages/create_cluster.png[]


[start=3]
3. Select *Amazon Web services*

image::images/acmimages/aws_cluster.png[]

[start=4]
4. Select *Standalone*

image::images/acmimages/standalone.png[]
...
[start=7]
7. Expand the *Worker Pools*, and change the worker node count to 0

image::images/acmimages/node_0.png[]

[start=8]
8. Click on step 7 to Review *before* proceeding, turn *YAML: ON at the top of the screen.*

9. Click on the *install-config* tab in the YAML window pane and *change the master replica number to 1* (will likely be 3).  Double check that the worker replica is 0.

image::images/acmimages/install-config.png[]

[start=10]
10. Click back on the *cluster* tab in the YAML window pane and locate the section that defines an object of type: *kind: MachinePool*. Add the following line at the end of the *MachinePool* section.
----
...
[start=11]
11. Click on “*Create*” and the single node cluster creation will go through.
...
image::images/acmimages/env_labels.png[]

[start=1]
1. Navigate to *Applications*
2. Click *Create application, select Subscription*. 

image::images/acmimages/create_sub_app.png[]
...
image::images/acmimages/label_sub.png[]
...
image::images/acmimages/book_topology.png[]
...
image::images/acmimages/book_website.png[]
...
[start=12]
12. Navigate to the Results screen, allow the remediation to complete, _it shouldn't take more than 3 minutes_

image::images/acmimages/no-violations.png[]
