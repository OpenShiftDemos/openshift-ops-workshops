...
5. Select the `Update channel` as `gitops-1.19` (version 1.19.0 was used when writing this module, but a later version may be available - use at your own discretion). Leave all defaults selected and click `Install`.
