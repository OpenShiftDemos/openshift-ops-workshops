...
----
cat {{ HOME_PATH }}/support/infra-nodes.sh
----
...
[source,bash,role="execute"]
----
bash {{ HOME_PATH }}/support/infra-nodes.sh
----
...
ip-10-0-133-134.us-east-2.compute.internal   Ready    infra,worker   8m     v1.14.6+97c81d00e
ip-10-0-133-191.us-east-2.compute.internal   Ready    worker         61m    v1.14.6+97c81d00e
ip-10-0-136-83.us-east-2.compute.internal    Ready    master         67m    v1.14.6+97c81d00e
ip-10-0-138-24.us-east-2.compute.internal    Ready    infra,worker   8m1s   v1.14.6+97c81d00e
ip-10-0-139-81.us-east-2.compute.internal    Ready    infra,worker   8m3s   v1.14.6+97c81d00e
ip-10-0-152-132.us-east-2.compute.internal   Ready    worker         61m    v1.14.6+97c81d00e
ip-10-0-157-139.us-east-2.compute.internal   Ready    master         67m    v1.14.6+97c81d00e
ip-10-0-167-9.us-east-2.compute.internal     Ready    worker         61m    v1.14.6+97c81d00e
ip-10-0-169-121.us-east-2.compute.internal   Ready    master         67m    v1.14.6+97c81d00e
```
...
And, in the `LABELS` column we see:
    ...
    ip-10-0-139-81.us-east-2.compute.internal   Ready    infra,worker   8m51s   v1.14.6+97c81d00e   beta.kubernetes.io/arch=amd64,beta.kubernetes.io/instance-type=m5.2xlarge,beta.kubernetes.io/os=linux,failure-domain.beta.kubernetes.io/region=us-east-2,failure-domain.beta.kubernetes.io/zone=us-east-2a,kubernetes.io/arch=amd64,kubernetes.io/hostname=ip-10-0-139-81,kubernetes.io/os=linux,node-role.kubernetes.io/infra=,node-role.kubernetes.io/worker=,node.openshift.io/os_id=rhcos
