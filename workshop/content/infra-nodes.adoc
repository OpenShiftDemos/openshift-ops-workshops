...
ip-10-0-128-220.us-east-2.compute.internal   Ready    infra,worker   2m25s   v1.14.6+9fb2d5cf9
ip-10-0-129-88.us-east-2.compute.internal    Ready    master         78m     v1.14.6+9fb2d5cf9
ip-10-0-138-216.us-east-2.compute.internal   Ready    infra,worker   2m36s   v1.14.6+9fb2d5cf9
ip-10-0-140-204.us-east-2.compute.internal   Ready    worker         72m     v1.14.6+9fb2d5cf9
ip-10-0-143-196.us-east-2.compute.internal   Ready    infra,worker   2m30s   v1.14.6+9fb2d5cf9
ip-10-0-154-172.us-east-2.compute.internal   Ready    worker         72m     v1.14.6+9fb2d5cf9
ip-10-0-159-34.us-east-2.compute.internal    Ready    master         78m     v1.14.6+9fb2d5cf9
ip-10-0-166-103.us-east-2.compute.internal   Ready    master         78m     v1.14.6+9fb2d5cf9
ip-10-0-170-246.us-east-2.compute.internal   Ready    worker         10m     v1.14.6+9fb2d5cf9
```
...
[source,bash,role="copypaste copypaste-warning"]
----
oc get node ip-10-0-128-138.us-east-1.compute.internal --show-labels
----

And, in the `LABELS` column we see:

    beta.kubernetes.io/arch=amd64,beta.kubernetes.io/instance-type=m5.2xlarge,beta.kubernetes.io/os=linux,failure-domain.beta.kubernetes.io/region=us-east-2,failure-domain.beta.kubernetes.io/zone=us-east-2a,kubernetes.io/arch=amd64,kubernetes.io/hostname=ip-10-0-128-220,kubernetes.io/os=linux,node-role.kubernetes.io/infra=,node-role.kubernetes.io/worker=,node.openshift.io/os_id=rhcos
