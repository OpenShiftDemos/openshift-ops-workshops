...
many administrative aspects of the cluster), we can now delve into Prometheus 
again. We briefly touched upon Prometheus in the infrastructure nodes module, 
but now we can proceed to log in and explore it further.
