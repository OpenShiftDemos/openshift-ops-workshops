...
[Warning]
====
IMPORTANT: Do not utilize the internal OpenShift Console provided within the workshop. Instead, it is crucial to access the external OpenShift Console available on the workshop's credentials page for proper functionality
====
