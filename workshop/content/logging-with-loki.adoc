...
[start=1]
1. Select the `Red Hat OpenShift Logging`. 
2. On the first page under `Provided APIs` and `Cluster Logging`, select `Create instance`.
3. Next, remove the current YAML and replace it with this YAML:
