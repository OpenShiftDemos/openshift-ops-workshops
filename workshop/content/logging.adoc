...
[Warning]
====
IMPORTANT: This step requires that you have completed the 'Deploying and Managing OpenShift Container Storage' Module. If you have not completed or don’t have this module listed as part of your workshop (Modern App Dev Roadshow - Ops Track), you will need to substitute 'storageClassName: ocs-storagecluster-ceph-rbd' with 'storageClassName: gp2' in the YAML below before copying to the editor.
====
