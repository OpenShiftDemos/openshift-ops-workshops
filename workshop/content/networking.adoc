...
[source,bash,role="execute"]
----
bash {{ HOME_PATH }}/content/support/create-net-projects.sh
----
...
[source,bash,role="execute"]
----
bash {{ HOME_PATH }}/content/support/test-connectivity.sh
----
...
[source,bash,role="execute"]
----
oc create -n netproj-b -f {{ HOME_PATH }}/content/support/network-policy-block-all.yaml
----
...
[source,bash,role="execute"]
----
oc create -n netproj-b -f {{ HOME_PATH }}/content/support/network-policy-allow-all-from-netproj-a.yaml
----
