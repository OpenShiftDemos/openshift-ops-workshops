...
[source,role="execute"]
----
oc get nodes -l node-role.kubernetes.io/worker -l '!node-role.kubernetes.io/infra'
----
.Example output:
----
...
cluster-ocs-0ec4-dgwqc-workerocs-us-east-2a-cqvwj   running   m4.4xlarge   us-east-2   us-east-2a   70s
cluster-ocs-0ec4-dgwqc-workerocs-us-east-2b-g5p5v   running   m4.4xlarge   us-east-2   us-east-2b   70s
cluster-ocs-0ec4-dgwqc-workerocs-us-east-2c-rx4v8   running   m4.4xlarge   us-east-2   us-east-2c   70s
----
...
If the ConfigMap already exists, apply the correct changes using this command:
...
"ip-10-0-131-209.us-east-2.compute.internal"
{
  ...
  "kubernetes.io/hostname": "ip-10-0-131-209",
...
"ip-10-0-133-99.us-east-2.compute.internal"
{
  ...
  "failure-domain.beta.kubernetes.io/zone": "us-east-2a",
  "kubernetes.io/arch": "amd64",
  "kubernetes.io/hostname": "ip-10-0-133-99",
  "kubernetes.io/os": "linux",
  "node-role.kubernetes.io/worker": "",
  "node.openshift.io/os_id": "rhcos",
  "role": "storage-node"
