...
|<5> | Counters | Shows the numbers of reads and writes issued against each provider
...
* 2 - Will let you select if you want to search a specific character string on either the `Name` or the `Label`
* 3 - Will let you enter the character string you are looking for
