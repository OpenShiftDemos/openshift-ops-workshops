...
In this section, you will first validate the OCP environment has 3 worker nodes before increasing the cluster size by additional 3 worker nodes for OCS resources. The `NAME` of your OCP nodes will be different than
shown below.
